...
class ICustomIcons:public QObject{
    ...
    public:
         ...
         */
        virtual void replaceIcon(quint32 index,const QPixmap& icon)=0;
    signals:
...
public:
    ...
    */
    virtual QPixmap& icon(quint32 index)=0;
    ...
    virtual quint32 builtinIcons()=0;
