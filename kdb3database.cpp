/*
 * kdb3database.cpp - <application name>
...
//#include "keepassx.h"       // EntryIcons, config

#include "lib/tools.h"      // CSTR
#include "crypto/sha256.h"  // SHA256
#include "crypto/twoclass.h"
#include "crypto/aescpp.h"  //AESdecrypt
...
QPixmap& Kdb3Database::icon(quint32 i){
...
void Kdb3Database::replaceIcon(quint32 id,const QPixmap& icon){
...
void Kdb3Database::parseCustomIconsMetaStream(const QByteArray& dta){
    ...
    for(quint32 i=0;i<NumIcons;i++){
        ...
        if(offset+Size > quint32(dta.size())){
            CustomIcons.clear();
