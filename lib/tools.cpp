...
#include <QPixmap>
#include <QPainter>
#include <QUrl>             // openBrowser()
#include <QDir>             // loadTranslation(), getAllTranslations()
#include <QSet>             // getAllTranslations()
#include <QLocale>          // installTranslator(), getAllTranslations()
#include <QLibrary>         // qtWindowsConfigPath()
#include "keepassx.h"       // config
#include "database.h"       // IEntryHandle
#include "crypto/yarrow.h"  // randomize
...
//N9	QMessageBox::critical(parent, QApplication::translate("Main","Error"), msg);
}
